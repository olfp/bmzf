...
#define sdCSTDLIBAPP_DEFAULT_PARTITION "SD:"
#define CSTDLIBAPP_DEFAULT_PARTITION "USB:"
...
/**/	  
    ...
    mNetDevice = "none"; // mOptions.GetNetDevice();
